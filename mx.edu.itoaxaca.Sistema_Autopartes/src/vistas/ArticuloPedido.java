 ...
 * @author magik
 */
public class ArticuloPedido extends javax.swing.JPanel {
    ...
    PedidoJpaController cp = new PedidoJpaController(emf);
    UsuarioJpaController cu= new UsuarioJpaController(emf);
     ...
     */
    public ArticuloPedido(String cargo) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(148, 200, 244));
        ...
        jLabel5.setFont(new java.awt.Font("Aparajita", 0, 24)); // NOI18N
    ...
    public void llenar(){
      ...
      for(int i=0;i<cp.getPedidoCount();i++){
          Pedido ac;
          ac=cp.findPedidoEntities().get(i);
          String ids= String.valueOf(ac.getPedidoId());
      ...
      //pr=us.findUsuarioEntities();
      
      for(int i=0;i<cu.getUsuarioCount();i++){
          Usuario ap;
          ap=cu.findUsuarioEntities().get(i);
   ...
   private void ActualizarTabla(){
        ...
        String[] titulos = {"ID PEDIDO","FECHA DEL PEDIDO","ID uSUARIO","USUARIO","TOTAL"};
       DefaultTableModel dt= new DefaultTableModel(titulos,0);
        for(int i=0;i<cp.getPedidoCount();i++){
          Pedido ac;
          ac=cp.findPedidoEntities().get(i);
         // String ids= String.valueOf(ac.getCompraId());
          Usuario p= cu.findUsuario(ac.getVendedor());
          fila[0]=ac.getPedidoId();
          fila[1]=ac.getFecha();
    ...
    private void idActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_idActionPerformed
        ...
        int caso =Integer.parseInt(String.valueOf(id.getSelectedItem()));
         ...
         Object [] fila=new Object[6]; 
        String[] titulos = {"ID PEDIO","FECHA DEL PEDIDO","ID USUARIO","USUARIO","TOTAL"};
       DefaultTableModel dt= new DefaultTableModel(titulos,0);
        for(int i=0;i<cp.getPedidoCount();i++){
          Pedido ac;
          
          ac=cp.findPedidoEntities().get(i);
          int ids = ac.getPedidoId();
          if(caso==ids){
              Usuario p= cu.findUsuario(ac.getVendedor());
          fila[0]=ac.getPedidoId();
          fila[1]=ac.getFecha();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      tabla.setModel(dt);  
             ...
             //Logger.getLogger(ArticuloPedido.class.getName()).log(Level.SEVERE, null, ex);
